        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Quản Lí Kho Hàng</b></a></li>
                </ul> 
            </div>  
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#importExcel" href title="In"><i class="fas fa-file-excel"></i> 
                                        Thêm Lô Hàng
                                    </a>
                                </div>
                            </div>  
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody> 
                                    <c:forEach items="${inventory}" var="ip">
                                        <tr>
                                            <td>${ip.getProduct().getProductID()}</td>
                                            <td>${ip.getProduct().getProductName()}</td>
                                            <td>${ip.getQuantity()}</td>
                                            <td><fmt:formatNumber>${ip.getProduct().getPrice()}</fmt:formatNumber></td> 
                                            <td>${ip.getReceiveDate()}</td>
                                            <td>${ip.getSupplier().getName()}</td>
                                            <td>${ip.getLocation().getLocationName()}</td>
                                            <td>
                        ...
                        <div class="modal fade" id="importExcel">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">  
                                    <h3 style="margin: 15px 0 15px 0; text-align: center" class="tile-title" >Import File Excel</h3>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-save" data-dismiss="modal" onclick="uploadFile()">Upload</button>
            ...
            function uploadFile() {
                ...
                if (!file) {
                    Swal.fire({
                        icon: "error",
                        title: "Thông Báo",
                        text: "Bạn cần chọn file trước khi Upload!", 
                    });
                    return;
                }
